...
3. **소문 채널 신호 유무 (WP54-3 확정 · 채널 3.5/5 (Form 4 미수집 · h6_membership 대체) · 2026-11-15 재실행 금지)**: 신호 있음 1866건 mean **+2.50%** [+1.02%, +4.16%] · 신호 없음 2745건 mean **+1.02%** [-0.05%, +2.17%] · **차이 +1.48%p** CI [-0.39%p, +3.45%p] · 판정: **불지지** (차이 CI 하한 < 0) · 단 **신호 있음 집단만 CI > 0 확정**
...
**Phase C (확장 단계) 진행 중** = 소문 채널 완비 진척 · h57 PubMed 200/307 · h58 Preprint 200/307 · 실채움 채널 3.5/5 (Form 4 미수집 · h6_membership 대체)
