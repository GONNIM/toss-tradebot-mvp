...
## §12 · 게이트 부수 효과 · 급등 다음날 냉각기 (2026-08-13 · Fable 5)

가격 검증 게이트 (`price_verification_failed` · vs_prior ±30% 초과) 의 1차 목적은 데이터 오염 방어 (스냅샷 파싱 오류·티커 혼입·단위 오류). 하지만 게이트가 **실 시장 급등에도 발동**하며, 이 부수 효과는 **의도된 방어 장치**로 보존.

### 실증 사례 · 2026-08-13 NBIS
- 2026-08-11 $193.23 → 08-12 $259.20 · **+34.14%** (2Q 실적 발표 · 매출 454% YoY · $582.3M)
- CNN 시세와 스냅샷 소수점 둘째 자리까지 일치 · 데이터 오염 (b) 아님 · 실 시장 이벤트 (a) 확정
- 게이트 발동 → 실행 계획 하루 보류 → NBIS 카드에서 "실적 서프라이즈 다음날 갭업 추격" 방지

### 정합성
- **Rulebook FOMO 방어 정합**: 실적 서프라이즈 다음날 갭업 추격은 전형적 FOMO · 하루 식히고 판단이 원칙
- 다음 정상 스냅샷 (예: $259 기준 ±30% 이내) 에서 **자동 해소** · 24시간 냉각기 · 사용자 개입 불필요
- **버그 아닌 기능**: "가격 오류 게이트" 가 "급등 냉각기" 로 이중 기능화

### 매뉴얼 원칙
- 실 시장 급등 시 게이트 발동 = "고쳐야 할 오탐" 아님 · 저널에 근거 기록 후 다음날 재판단
- 급등 다음날 카드가 보류 상태로 뜨면 → 반대 논거 (예: 정점론·공매도 시각) 도 함께 검토 후 저널 thesis 에 기록

---

## Meta · 문서 갱신 이력

- 2026-08-13 · §12 게이트 부수 효과 (냉각기) 추가 · NBIS 실증 · Fable 5 3차 권고
