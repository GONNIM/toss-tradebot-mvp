...
### 광범위 영향 우려 (후속 P2-4c)
- 리스트 26 종목 중 상당수가 동일 파싱 오류일 가능성 큼
- 특히 중소기업·건설·기타 업종에서 `"차입금등"` 표기 사용 시 미매치
- **후속** · 전 종목 record 삭제→재수집으로 재파싱 · 티어 대량 재판정 필요
...
| 2026-07-18 | v1.5 | P2-4b hotfix 완결 (_DEBT_KEYWORDS 확장 · diag 저장) · §12 서희 재판정 실측 신설 (tier_2_near · rejected · net_cash 16.3%) · 반박문 §6·§9 및 재재반박 §6 오예측 정정 · 광범위 파싱 오류 후속 P2-4c 신설 | (pending) |
