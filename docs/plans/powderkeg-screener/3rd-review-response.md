...
- **예수부채 처리** · 은행·증권업 예금성 부채 · 별도 로직 (v2)
...
| 2026-07-18 | v1.7 | P2-4d 완결 · `"차입금"`·`"차입부채"` 매핑 추가 · LG화학·영풍·LS증권 파싱 성공 · LS증권 rejected→tier_3_watch · **26/26 total_debt 100% 매칭** · 남은 P2-4e 는 v2 백로그로 | (pending) |
