...
| 공정위 대기업집단 | 72 | 수동 seed (v2 · 자동 갱신 대기) |
...
| 2026-07-16 | v1.12 | 리뷰어 지적 #3 (팔림세스트) · §4 잡 주기 3m/1m 반영 · §6 이벤트 5,100건 · §8-1 표본 최신 (A3=1,550 등) · §8-2 종합 "전 완결" · §9-1 v1.10/v1.11 반영 · §9-5 v1.7 완결 · §10-2 delisted 컬럼 추가 | (본 커밋) |
