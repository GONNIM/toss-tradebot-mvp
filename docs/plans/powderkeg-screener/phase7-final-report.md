...
| 2026-07-16 | v1.14 | 리뷰어 지적 #5 (강건성 뱃지) · screener 조건별 임계 margin 계산 · robustness_score/grade (strong/moderate/borderline/at_risk) · 프론트 뱃지 표시 · 서희건설 borderline 예상 (PBR/net_cash 경계선) | (본 커밋) |
